...
uint8 ConvertToBorder(uint8 pixnum,uint8 pixel,char flag);
int   Edge_Tracking();
int8  Track_Scanning(uint8* fork_head,uint8* fork_tail,int track_end);
uint8 AcquireRealBorder(uint8 fork_head,uint8 fork_tail,int8 fork_flag,int track_end);
